...
export async function POST(req: Request) {
  ...
  const systemMessage = {
    ...
    content:
      ...
      "- Track stat categories, meaning you know the difference between Physical, Special, and Status moves. Know which stats (Attack, Special Attack, Defense, etc.) each Pokémon excels in, and that attack attacks defense, and sp attack attacks special defense." +
